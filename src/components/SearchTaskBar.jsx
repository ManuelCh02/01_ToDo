...
import styles from "../styles/SearchTasksBar.module.css"

export function SearchTaskBar({handleTaskSearching}) {
    return (
        <label
            className={styles.taskBarContainer}   
        >
            <svg className={styles.taskBarIcon} width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <input 
                ...
                onChange={(e) => {handleTaskSearching(e.target.value)}}
            />
        </label>
    )
}