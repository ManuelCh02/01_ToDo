    ...
    return (
        <div>
            <div>
                ...
                <div>
                    <ul>
                        <li onClick={() => addLabelsToTask("today")}>
                        ...
                        <li onClick={() => addLabelsToTask("work")}>
                            <svg width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li onClick={() => addLabelsToTask("study")}>
                            <svg width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li onClick={() => addLabelsToTask("college")}>
                        ...
                        <li onClick={() => addLabelsToTask("personal")}>
